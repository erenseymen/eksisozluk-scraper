...
complete -c eksisozluk-scraper -l delay -d "Request'ler arası bekleme süresi (saniye, varsayılan: 0)" -r
complete -c eksisozluk-scraper -l max-retries -d "Maksimum tekrar deneme sayısı (varsayılan: 3)" -r
complete -c eksisozluk-scraper -l retry-delay -d "Retry arası bekleme süresi (saniye, varsayılan: 1)" -r
